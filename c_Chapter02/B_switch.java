...
// - defalut 문으로 해당되는 case가 없을때 실행할 구문을 작성
...
//		Switch문을 사용하여 선택에 따른 온도 변환
		...
		case 1:
			...
			System.out.println("섭씨 "+temperature+"도는 화씨로"+fahrenheit+"도입니다.");
			break;
		case 2:
		...
		default:
			...
			System.out.println("잘못된 선택입니다. 1또는 3를 선택해주세요.");
			break;
		}
	}
